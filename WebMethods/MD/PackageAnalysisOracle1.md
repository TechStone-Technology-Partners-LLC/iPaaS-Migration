...
| Trigger | callable_recipe | Update Item Info | Receives 4-field JSON |
For Trigger use WorkatoServiceTrigger.json as a reference. For fields use ProductNumber, ItemNo, Product Description, ProductName as schema fields.
| 1 | Oracle Select Rows | Select Rows | WHERE condition , 2 params |
Configure the Workato Action Oracle Select Rows. Where condition is  ProductNumber exist and ItemNo doesn’t exist
| 2 | IF/ELSE | Check Size=5 | Condition: Size == “5” |
| 2a | STOP With Error  | STOP | Reason for failure This is not good|
Use Stop.json as a reference for step 2a
| 2b | Return Response for callable_recipe | Return response from All done |
